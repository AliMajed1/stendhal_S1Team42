...
import games.stendhal.server.maps.deniran.StallWorkerNPC3;
...
public class FleaMarketExistTest3 extends ZonePlayerAndNPCTestImpl {
	
	
	private static StallWorkerNPC3 worker = new StallWorkerNPC3();
	...
	public FleaMarketExistTest3() {
		super(ZONE_NAME, "Stall Worker3");
	}
	...
	public void workerChatTest() {
		SpeakerNPC worker = SingletonRepository.getNPCList().get("Stall Worker3");
	...
	public void marketSignInCorrectLocation() {
		...
		final ShopSign sellBlackboard = (ShopSign) zone.getEntityAt(38, 90);
