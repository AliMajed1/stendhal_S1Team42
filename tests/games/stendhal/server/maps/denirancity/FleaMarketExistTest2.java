...
import games.stendhal.server.maps.deniran.StallWorkerNPC2;
...
public class FleaMarketExistTest2 extends ZonePlayerAndNPCTestImpl {
	
	
	private static StallWorkerNPC2 worker = new StallWorkerNPC2();
	...
	public FleaMarketExistTest2() {
		super(ZONE_NAME, "Stall Worker2");
	}
	...
	public void workerChatTest() {
		SpeakerNPC worker = SingletonRepository.getNPCList().get("Stall Worker2");
	...
	public void marketSignInCorrectLocation() {
		...
		final ShopSign sellBlackboard = (ShopSign) zone.getEntityAt(38, 95);
