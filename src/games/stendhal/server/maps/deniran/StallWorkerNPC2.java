...
public class StallWorkerNPC2 implements ZoneConfigurator {
	...
	private void buildNPC(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Stall Worker2");
