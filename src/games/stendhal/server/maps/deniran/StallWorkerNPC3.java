...
public class StallWorkerNPC3 implements ZoneConfigurator {
	...
	private void buildNPC(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Stall Worker3");
